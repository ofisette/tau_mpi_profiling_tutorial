...
[http://www.cs.uoregon.edu/Research/tau/docs.php Tau documentation] is available
on the project [http://www.cs.uoregon.edu/Research/tau/ Web site]. We recommend
reading the user guide, especially the first section which describes the
instrumentation process, and also the section ''Some Common Application
Scenario''.
